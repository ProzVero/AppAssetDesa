...
public class DetailARTAdapter extends RecyclerView.Adapter<DetailARTAdapter.HolderData> {
    ...
    private final ArrayList<DataPendudukModel> pendudukModels;
    ...
    public class HolderData extends RecyclerView.ViewHolder {
        ...
        private final TextView nama_art;
        private final TextView tgl_lahir;
        private final TextView kelamin;
        private final TextView dusun;
