...
public class KritikLimitAdapter extends RecyclerView.Adapter<KritikLimitAdapter.HolderData> {
    ...
    private final ArrayList<DataKritikModel> dataKritikModels;
    ...
    public class HolderData extends RecyclerView.ViewHolder {
        private final TextView txt_nama;
        private final TextView txt_kritik;
        private final TextView txt_tgl;
        private final TextView txt_id;
        private final ImageButton btn_option;
